...
</div>`, `<table> <caption>Ranking dos Entregador</caption> <tbody> <tr> <td class="tabTitu">1° Lugar</td> <td>Entregador 1</td> </tr> <tr> <td class="tabTitu">2° Lugar</td> <td>Entregador 2</td> </tr> <tr> <td class="tabTitu">3° Lugar</td> <td>Entregador 3</td> </tr> <tr> <td class="tabTitu">4° Lugar</td> <td>Entregador 4</td> </tr> <tr> <td class="tabTitu">7° Lugar</td> <td>Você</td> </tr> </tbody> </table>`, `<div id="chat"> <div id="contatos"> <h2>Contatos</h2> <div onclick="clicar2()"> <span>Cliente 1</span> </div> <div onclick="clicar2()"> <span>Cliente 2</span> </div> <div onclick="clicar2()"> <span>Cliente 3</span> </div> </div> <div id="conversa"> <h2>Cliente</h2> <div id="body"> <div class="mens"></div> <div class="mens"></div> <div class="mens"></div> <div class="mens"></div> </div> <form> <input type="text" id="txt" placeholder="Digite a Sua Mensagem"> <button type="button" id="txtEnviar" onclick="clicar2()">Enviar</button> </form> </div> </div>`,
 `<div id="ofertas">
